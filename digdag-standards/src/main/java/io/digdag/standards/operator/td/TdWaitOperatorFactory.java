        ...
        implements OperatorFactory
{
    ...
    @Inject
    public TdWaitOperatorFactory(TemplateEngine templateEngine)
    {
    ...
    {
        public TdWaitOperator(Path workspacePath, TaskRequest request)
        {
        ...
        public TaskResult runTask()
        {
            ...
            int interval = params.get("interval", int.class, (int) Duration.ofMinutes(5).getSeconds());
            ...
            if (done) {
                ...
                throw TaskExecutionException.ofNextPolling(interval, ConfigElement.copyOf(request.getLastStateParams()));
            }
        }
    }
